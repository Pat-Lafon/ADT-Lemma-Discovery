...
implies            (list_last dt u_1) 
           (
            ...
            (
             ...
             (implies (list_last dt u_0) (u_1==u_0))
            )
           )
          ) &&
          (
...
implies              (list_head dt u_1) 
             (
              (
implies                ((list_order dt u_1 u_0) && (list_once dt u_0)) 
               (
...
implies not               (list_order dt u_1 u_0) 
               ((list_once dt u_1) && (list_head dt u_0))
              )
             )
            ) &&
            (
...
not                  (list_next dt u_1 u_0)
               ...
               (
implies not                (list_order dt u_0 u_1) 
                ((u_1==u_0) && (list_once dt u_1))
               )
              )
             )
            )
