...
let rec balance (r : bool) (tree1 : Rbset.t) (x : int) (tree2 : Rbset.t) =
  ...
  | _
    when ( false,
           Rbset.tree true
             (Rbset.tree true (a1 : Rbset.t) (x1 : int) (b1 : Rbset.t))
             (y1 : int)
             (c1 : Rbset.t),
           (z1 : int),
           (d1 : Rbset.t) ) ->
  ...
  | _
    when ( false,
           Rbset.tree true
             (a2 : Rbset.t)
             (x2 : int)
             (Rbset.tree true (b2 : Rbset.t) (y2 : int) (c2 : Rbset.t)),
           (z2 : int),
           (d2 : Rbset.t) ) ->
  ...
  | _
    when ( false,
           ...
           (x3 : int),
           Rbset.tree true
             (Rbset.tree true (b3 : Rbset.t) (y3 : int) (c3 : Rbset.t))
             (z3 : int)
             (d3 : Rbset.t) ) ->
  ...
  | _
    when ( false,
           ...
           Rbset.tree true
             (b4 : Rbset.t)
             (y4 : int)
             (Rbset.tree true (c4 : Rbset.t) (z4 : int) (d4 : Rbset.t)) ) ->
